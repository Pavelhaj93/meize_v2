...
export default function Footer() {
	...
	return (
		<footer
			className={cn("py-10 text-sm text-center md:text-left", {
		...
		>
			<Container className="flex flex-col md:flex-row md:justify-between items-center gap-10 lg:gap-20">
				...
				<div className="order-2 md:order-3 flex-1 flex flex-col items-center md:items-end gap-0.5">
					<a href="mailto:info@meize.cz" className="hover:underline">
						info@meize.cz
					</a>
					<a href="tel:+420602687255" className="hover:underline">
						+420 602 687 255
					</a>
					<a href="tel:+420776132630" className="hover:underline">
						+420 776 132 630
					</a>
				</div>
			</Container>
